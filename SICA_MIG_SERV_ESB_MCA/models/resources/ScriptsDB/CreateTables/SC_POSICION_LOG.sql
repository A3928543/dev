/*
 * $Id: SC_POSICION_LOG.sql,v 1.12 2008/02/22 18:25:11 ccovian Exp $
...
/* Cuando se modifique la estructura de esta tabla se debera
   ...
   correspondiente que se llama SC_H_POSICION_LOG
 */

DROP TABLE SICA_ADMIN.SC_POSICION_LOG;

CREATE TABLE SICA_ADMIN.SC_POSICION_LOG (
...
CREATE PUBLIC SYNONYM SC_POSICION_LOG FOR SICA_ADMIN.SC_POSICION_LOG;
/