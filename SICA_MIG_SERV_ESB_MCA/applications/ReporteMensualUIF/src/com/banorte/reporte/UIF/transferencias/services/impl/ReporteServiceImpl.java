...
public class ReporteServiceImpl implements IReporteService
{
	...
	public ByteArrayOutputStream crearReporteExcel(List<DatosTransferenciaRecibida> transferencias)
	{
        ...
        for(indice = 0;indice < 1;indice ++)
        {
          ...
          crearCelda(fila, alineacionCentro, creationHelper, "<monto_usd_mayor_igual_1000>", 39);        	
          crearCelda(fila, alineacionCentro, creationHelper, "<pais_cliente_originador>", 40);        	
        }
        ...
        for(indice = 0; indice < transferencias.size(); indice++)
        {
        	...
        	crearCelda(fila, alineacionIzquierda, creationHelper, transferencia.getMontoUsdMayorIgual1000(), 39);
        	crearCelda(fila, alineacionIzquierda, creationHelper, transferencia.getPaisClienteOriginador(), 40);
        }
