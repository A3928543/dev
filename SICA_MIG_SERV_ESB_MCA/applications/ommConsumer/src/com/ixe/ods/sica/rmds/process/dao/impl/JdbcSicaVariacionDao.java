...
public class JdbcSicaVariacionDao implements SicaVariacionDao {
	...
	public boolean storeVariacion(Map<String, CurrencyPriceDto> sicaVariacionCache){
		...
		SimpleJdbcInsert sicaVariacionInsert = new SimpleJdbcInsert(dataSource)
			.withTableName(VARIACION_TAB_NAME).usingColumns(ID_VARIACION_COLUMN,FECHA_COLUMN,VARIACION_MID_COLUMN,
					VARIACION_VTA_SPOT_COLUMN,VARIACION_VTA_SPOT_ASK_COLUMN, MXN_EUR_VARIACION_VTA_SPOT_COLUMN,
					MXN_EUR_VARIACION_VTA_SPOT_ASK_COLUMN, CAD_VARIACION_VTA_SPOT_COLUMN, CAD_VARIACION_VTA_SPOT_ASK_COLUMN,
					CHF_VARIACION_VTA_SPOT_COLUMN, CHF_VARIACION_VTA_SPOT_ASK_COLUMN,EUR_VARIACION_VTA_SPOT_COLUMN,
					EUR_VARIACION_VTA_SPOT_ASK_COLUMN,GBP_VARIACION_VTA_SPOT_COLUMN,GBP_VARIACION_VTA_SPOT_ASK_COLUMN,
					JPY_VARIACION_VTA_SPOT_COLUMN,JPY_VARIACION_VTA_SPOT_ASK_COLUMN,ORIGEN_COLUMN);
