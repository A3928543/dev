...
public class HeaderResponseType  implements java.io.Serializable {
     ...
     * 						Negocio */
    private com.banorte.ws.esb.mantenimientodatosbasicos.headers.EstadoRespuestaType estadoRespuesta;
    ...
    public HeaderResponseType(
           ...
           com.banorte.ws.esb.mantenimientodatosbasicos.headers.EstadoRespuestaType estadoRespuesta,
     ...
     * 						Negocio
     */
    public com.banorte.ws.esb.mantenimientodatosbasicos.headers.EstadoRespuestaType getEstadoRespuesta() {
     ...
     * 						Negocio
     */
    public void setEstadoRespuesta(com.banorte.ws.esb.mantenimientodatosbasicos.headers.EstadoRespuestaType estadoRespuesta) {
        this.estadoRespuesta = estadoRespuesta;
    }
