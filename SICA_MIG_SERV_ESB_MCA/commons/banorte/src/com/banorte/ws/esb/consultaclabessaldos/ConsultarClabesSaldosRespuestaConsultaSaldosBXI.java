/**
 * ConsultarClabesSaldosRespuestaConsultaSaldosBXI.java
 *
...
public class ConsultarClabesSaldosRespuestaConsultaSaldosBXI  implements java.io.Serializable {
    ...
    /* SALDO MES ANTERIOR */
    private java.math.BigDecimal saldoMesAnterior;

    /* REGIMEN DE FIRMAS */
    private java.lang.String regimenFirmas;

    public ConsultarClabesSaldosRespuestaConsultaSaldosBXI() {
    }
    ...
    public ConsultarClabesSaldosRespuestaConsultaSaldosBXI(
           ...
           java.math.BigDecimal saldoMesAnterior,
    ...
    /**
     * Gets the fechaProceso value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
     * @return fechaProceso
     */
    ...
    /**
     * Sets the fechaProceso value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
     * @param fechaProceso
     */
    ...
    /**
     * Gets the tran_NumeroCuenta value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the tran_NumeroCuenta value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the clabeCuenta value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the clabeCuenta value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the crOrigen value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the crOrigen value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the descripcionSucursal value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the descripcionSucursal value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the saldoInicial value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the saldoInicial value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the tran_TipoDivisa value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the tran_TipoDivisa value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the saldoDisponible value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the saldoDisponible value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the saldoRetenido value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the saldoRetenido value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the saldoDia value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the saldoDia value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Gets the saldoMesAnterior value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
     * @return saldoMesAnterior   * SALDO MES ANTERIOR
     */
    public java.math.BigDecimal getSaldoMesAnterior() {
        return saldoMesAnterior;
    }


    /**
     * Sets the saldoMesAnterior value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
     * @param saldoMesAnterior   * SALDO MES ANTERIOR
     */
    public void setSaldoMesAnterior(java.math.BigDecimal saldoMesAnterior) {
        this.saldoMesAnterior = saldoMesAnterior;
    }


    /**
     * Gets the regimenFirmas value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    /**
     * Sets the regimenFirmas value for this ConsultarClabesSaldosRespuestaConsultaSaldosBXI.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarClabesSaldosRespuestaConsultaSaldosBXI)) return false;
        ConsultarClabesSaldosRespuestaConsultaSaldosBXI other = (ConsultarClabesSaldosRespuestaConsultaSaldosBXI) obj;
        ...
        _equals = true && 
            ...
            ((this.saldoMesAnterior==null && other.getSaldoMesAnterior()==null) || 
             (this.saldoMesAnterior!=null &&
              this.saldoMesAnterior.equals(other.getSaldoMesAnterior()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSaldoMesAnterior() != null) {
            _hashCode += getSaldoMesAnterior().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarClabesSaldosRespuestaConsultaSaldosBXI.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.banorte.com/ws/esb/ConsultaClabesSaldos", ">consultarClabesSaldosRespuesta>ConsultaSaldosBXI"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("saldoMesAnterior");
        elemField.setXmlName(new javax.xml.namespace.QName("", "SaldoMesAnterior"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "decimal"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
