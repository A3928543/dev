...
public class HeaderRequestType  implements java.io.Serializable {
    private com.banorte.ws.esb.consultaclabessaldos.headers.DespliegueType despliegue;

    private com.banorte.ws.esb.consultaclabessaldos.headers.AccesoType acceso;

    private com.banorte.ws.esb.consultaclabessaldos.headers.ConsumidorType consumidor;

    private com.banorte.ws.esb.consultaclabessaldos.headers.RequestType datosPeticion;

    private com.banorte.ws.esb.consultaclabessaldos.headers.PropiedadType[] datosVariables;
    ...
    public HeaderRequestType(
           com.banorte.ws.esb.consultaclabessaldos.headers.DespliegueType despliegue,
           com.banorte.ws.esb.consultaclabessaldos.headers.AccesoType acceso,
           com.banorte.ws.esb.consultaclabessaldos.headers.ConsumidorType consumidor,
           com.banorte.ws.esb.consultaclabessaldos.headers.RequestType datosPeticion,
           com.banorte.ws.esb.consultaclabessaldos.headers.PropiedadType[] datosVariables,
     ...
     * @return despliegue
     */
    public com.banorte.ws.esb.consultaclabessaldos.headers.DespliegueType getDespliegue() {
        return despliegue;
    }
     ...
     * @param despliegue
     */
    public void setDespliegue(com.banorte.ws.esb.consultaclabessaldos.headers.DespliegueType despliegue) {
        this.despliegue = despliegue;
    }
     ...
     * @return acceso
     */
    public com.banorte.ws.esb.consultaclabessaldos.headers.AccesoType getAcceso() {
        return acceso;
    }
     ...
     * @param acceso
     */
    public void setAcceso(com.banorte.ws.esb.consultaclabessaldos.headers.AccesoType acceso) {
        this.acceso = acceso;
    }
     ...
     * @return consumidor
     */
    public com.banorte.ws.esb.consultaclabessaldos.headers.ConsumidorType getConsumidor() {
        return consumidor;
    }
     ...
     * @param consumidor
     */
    public void setConsumidor(com.banorte.ws.esb.consultaclabessaldos.headers.ConsumidorType consumidor) {
        this.consumidor = consumidor;
    }
     ...
     */
    public com.banorte.ws.esb.consultaclabessaldos.headers.RequestType getDatosPeticion() {
        return datosPeticion;
    }
     ...
     * @param datosPeticion
     */
    public void setDatosPeticion(com.banorte.ws.esb.consultaclabessaldos.headers.RequestType datosPeticion) {
        this.datosPeticion = datosPeticion;
    }
     ...
     */
    public com.banorte.ws.esb.consultaclabessaldos.headers.PropiedadType[] getDatosVariables() {
        return datosVariables;
    }
     ...
     */
    public void setDatosVariables(com.banorte.ws.esb.consultaclabessaldos.headers.PropiedadType[] datosVariables) {
        this.datosVariables = datosVariables;
    }
