...
public class ESBResponseType  implements java.io.Serializable {
    private com.banorte.www.ws.ESBResponse.ConsultaIdIxeAltamira.HeaderResType header;

    private com.banorte.www.ws.ESBResponse.ConsultaIdIxeAltamira.ResponseType response;

    public ESBResponseType() {
    }

    public ESBResponseType(
           com.banorte.www.ws.ESBResponse.ConsultaIdIxeAltamira.HeaderResType header,
           com.banorte.www.ws.ESBResponse.ConsultaIdIxeAltamira.ResponseType response) {
           this.header = header;
     ...
     * @return header
     */
    public com.banorte.www.ws.ESBResponse.ConsultaIdIxeAltamira.HeaderResType getHeader() {
        return header;
    }
     ...
     * @param header
     */
    public void setHeader(com.banorte.www.ws.ESBResponse.ConsultaIdIxeAltamira.HeaderResType header) {
        this.header = header;
    }
     ...
     * @return response
     */
    public com.banorte.www.ws.ESBResponse.ConsultaIdIxeAltamira.ResponseType getResponse() {
        return response;
    }
     ...
     * @param response
     */
    public void setResponse(com.banorte.www.ws.ESBResponse.ConsultaIdIxeAltamira.ResponseType response) {
        this.response = response;
    }
