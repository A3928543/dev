...
public class ESBRequestType  implements java.io.Serializable {
    private com.banorte.www.ws.ESBRequest.HeaderReq header;

    private com.banorte.www.ws.ESBRequest.Request request;

    public ESBRequestType() {
    }

    public ESBRequestType(
           com.banorte.www.ws.ESBRequest.HeaderReq header,
           com.banorte.www.ws.ESBRequest.Request request) {
           this.header = header;
     ...
     * @return header
     */
    public com.banorte.www.ws.ESBRequest.HeaderReq getHeader() {
        return header;
    }
     ...
     * @param header
     */
    public void setHeader(com.banorte.www.ws.ESBRequest.HeaderReq header) {
        this.header = header;
    }
     ...
     * @return request
     */
    public com.banorte.www.ws.ESBRequest.Request getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(com.banorte.www.ws.ESBRequest.Request request) {
        this.request = request;
    }
